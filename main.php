...
<?php include 'header.php'?>
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/homepage.jpg); width:100%; height: 656px;"></div>
			<!-- /Backgound Image -->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							margin-bottom:50px;">Start your career with us :)</h1>
							
							<?php
								// Check if the user is logged in, if not then redirect him to login page
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									<p class="lead white-text" style="margin-left: 5px;" ><b>Discover yourself<br>Find what is perfect for your future</b></p>
								...
								<?php else: ?>
									...
									<a class="main-button icon-button" style="background-color: rgb(172,203,225) !;" href="http://127.0.0.1:5000/">Get Started!</a>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to Career Space</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Career Space</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
